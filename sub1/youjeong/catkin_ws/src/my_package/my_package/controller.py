...
class Controller(Node):
    ...
    def timer_callback(self):
        ...
        가전 제품 : 가전상태 출력        
        '''
        self.get_logger().info('Turtlebot Status: %s' % self.turtlebot_status_msg)
        self.get_logger().info('Enviroment Status: %s' % self.envir_status_msg)
        self.get_logger().info('App Status: %s' % self.app_status_msg)
