...
class Controller(Node):
    ...
    def timer_callback(self):
        ...
        if self.is_turtlebot_status:
            print("Turtlebot Status")
            print("Linear Velocity : ",self.turtlebot_status_msg.linear_velocity)
            print("Angular Velocity : ",self.turtlebot_status_msg.angular_velocity)
            print("Battery : ",self.turtlebot_status_msg.battery)
            print("Charging : ",self.turtlebot_status_msg.charging)
            self.is_turtlebot_status=False
        if self.is_envir_status:
            print("Enviroment Status")
            print("Date : ",self.envir_status_msg.date)
            print("Time : ",self.envir_status_msg.time)
            print("Temperature : ",self.envir_status_msg.temperature)
            print("Weather : ",self.envir_status_msg.weather)
            self.is_envir_status=False
