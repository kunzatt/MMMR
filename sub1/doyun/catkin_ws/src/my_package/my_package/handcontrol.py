...
class Handcontrol(Node):
    ...
    def hand_control_status(self):
        ...
        '''
        print("현재 HandControl 상태:")
        print(f"can_use_hand: {self.turtlebot_status_msg.turtle.can_use_hand}")
        print(f"can_lift: {self.turtlebot_status_msg.can_lift}")
        print(f"can_put: {self.turtlebot_status_msg.can_put}")

    def hand_control_preview(self):
        '''
        로직 4. Hand Control - Preview
        '''
        self.hand_control_msg.cmd=1
        self.hand_control.publish(self.hand_control_msg)
        time.sleep(3)
        self.hand_control_msg.cmd=0
        self.hand_control.publish(self.hand_control_msg)
    ...
    def hand_control_put_down(self):        
        ...
        '''
        self.hand_control_msg.cmd=3
        self.hand_control.put_distance = 1
        self.hand_control.put_height = 1
        self.hand_control.publish(self.hand_control_msg)
        time.sleep(3)
        self.hand_control_msg.cmd=0
        self.hand_control.publish(self.hand_control_msg)
