...
public class WeatherController {
	...
	@Operation(
		summary = "종합 날씨 정보 조회",
		description = "사용자 프로필의 주소를 기반으로 OpenWeatherMap API를 사용하여 현재 날씨, 기온, 습도, 옷차림 추천, 우산 필요 여부 정보를 제공합니다."
	)
	@ApiResponses({
	...
	@GetMapping
	public ResponseEntity<ApiResponse> getWeather(@CurrentUser AuthUser authUser) {
		String address = authUser.getAddress();
		System.out.println(address);
		WeatherResponseDto response = weatherService.getComprehensiveWeather(address);
